        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Andre Rosa</a></h1>
              <span className="email"><i className="icon-mail"></i> andre.rosa.author@gmail.com</span>
            </div>
            ...
            <div className="colorlib-footer">
              <p><small>
                  Written with <i className="icon-heart" aria-hidden="true" /> and <i className="icon-wine" aria-hidden="true"></i><br></br>
                  Thanks <a href="https://github.com/dbarochiya/me" target="_blank" rel="noopener noreferrer">D. Barochia</a> for the amazing code.  
              </small></p>
              {/* <p><small>
